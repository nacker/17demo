	...
	while((myDirent = readdir(pDir)) != NULL)
	{
		...
		{//将当前的文件名存储在string中便于查找后缀
			...
			if(index != std::string::npos)
			{
                ...
                if(suffix == ".c" || suffix == ".cpp" || suffix == ".h" || suffix == ".java" || suffix == ".xml" || suffix == ".html" || suffix == ".css" || suffix == ".js" || suffix == ".py" || suffix == ".go" || suffix == ".php" || suffix == ".m" || suffix == ".mm" || suffix == ".cs" || suffix == ".asp" || suffix == ".aspx" || suffix == ".jsp")
				{
